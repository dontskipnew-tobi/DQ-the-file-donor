...
API_ID = int(environ['20478011'])
API_HASH = environ['0e4dcf39643e83c3c174a0d2370e5b4a']
BOT_TOKEN = environ['8231530189:AAFoz0hdEoVyJZ-iZHNdCcRcfZHy0Mm30xQ']
...
AUTH_CHANNEL = [int(auth_channel) for auth_channel in environ.get('AUTH_CHANNEL', '-1002459768638').split() if id_pattern.search(auth_channel)]
...
# MongoDB information
SECONDDB_URI = environ.get('SECONDDB_URI', "mongodb+srv://renamebot:amrenamebot@cluster0.5ornz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
